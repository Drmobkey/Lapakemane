...
class Helper{
        ...
        if($order){
            ...
            $order_price=self::orderPrice($id,$user_id);
                                                if (isset($_SESSION['random_discount'])) {
                                                    ...
                                                    $random_discount = str_pad(mt_rand(101, 999), 3, '0', STR_PAD_LEFT);
                                                    $_SESSION['random_discount'] = $random_discount;
                                                }
                                                $total_admin += intval($random_discount) / 1;
            return number_format((float)($order_price+$shipping_price+$total_admin),0,'.','');
        }else{
            return 0;
        }
    }
    ...
    public function formatPriceToIDR($price) {
