...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Gagal');
        }
    ...
    public function edit($id)
    {
        ...
        if(!$shipping){
            request()->session()->flash('error','Tidak ada pengiriman');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Pengiriman berhasil diupdated');
        }
        else{
            request()->session()->flash('error','Gagal, Coba lagi');
        }
        return redirect()->route('shipping.index');
    }
    ...
    public function destroy($id)
    {
        ...
        if($shipping){
            ...
            if($status){
                request()->session()->flash('success','Shipping berhasil dihapus');
            }
            else{
                request()->session()->flash('error','Gagal, Coba lagi');
            }
