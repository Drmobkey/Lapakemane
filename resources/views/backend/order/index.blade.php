            ...
            @endphp 
                <tr>
                    ...
                    <td>
                      @if($order->bukti)
                      @php
                      $bukti=explode(',',$order->bukti);
                      // dd($photo);
                      @endphp
                      <a href="{{$order->bukti}}" data-lightbox="bukti-pembayaran" data-title="Bukti Pembayaran">
                        <img src="{{$order->bukti}}" style="max-width:80px" class="img-fluid zoom" alt="{{$order->bukti}}" style="max-width: 80px;">
                      </a>
                      @endif
                    </td>
