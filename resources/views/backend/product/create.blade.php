...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Caption <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="is_featured">Apakah Induk?</label><br>
        ...
        {{-- < class="form-group">
          ...
          <div class="form-group">
            <label for="berat" class="col-form-label">Berat (g) <span class="text-danger">*</span></label>
<input id="berat" type="number" name="berat" placeholder="Masukkan berat dalam gram" value="{{old('berat')}}" class="form-control">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
              <span class="input-group-btn">
                  ...
                  <i class="fa fa-picture-o" style="color:white"></i> Pilih
                  </a>
              </span>
