...
@section('title','Lapakemane | Beranda')
                    ...
                    @if($cat->is_parent==1)
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            <div class="single-banner">
                                ...
                                <div class="content">
                                    <h3>{{$cat->title}}</h3>
                                        <a href="{{route('product-cat',$cat->slug)}}">Jelajahi!</a>
                                </div>
                            </div>
                        </div>
                    @endif
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    ...
                                                    <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Tambah Wishlist</span></a>
                                                </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @php
                                            $after_discount=($product->price-($product->price*$product->discount)/100);
                                        @endphp
                                        <h3><small><del class="text-muted">Rp {{number_format($product->price,0, ',', '.')}}</del></small>    ${{number_format($after_discount,2)}}  </h3>
