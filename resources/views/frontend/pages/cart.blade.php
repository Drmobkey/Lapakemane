...
@section('title','Lapakemane | Keranjang')
								...
								@else
										<tr>
											<td class="text-center">
												Tidak ada item disini <a href="{{route('product-grids')}}" style="color:blue;">Lanjutkan belanja</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Lebih hemat<span>${{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Harus Bayar<span>Rp {{number_format($total_amount,0, ',', '.')}}</span></li>
										@else
											<li class="last" id="order_total_price">Harus Bayar<span>Rp {{number_format($total_amount,0, ',', '.')}}</span></li>
										@endif
									</ul>
