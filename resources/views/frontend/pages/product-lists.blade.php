...
@section('title','Lapakemane | Produk')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Belanja</a></li>
							</ul>
						</div>
					</div>
				</div>
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	<a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Belanja langsung</span></a>
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Tambah Wishlist</span></a>
																</div>
																<div class="product-action-2">
																	<a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Tambah keranjang</a>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											{{-- <div class="quickview-content">
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">${{number_format($product->price,2)}}</del></small>    Rp {{number_format($after_discount,0, ',', '.')}}  </h3>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
	...
	<script>
        ...
        if ($("#slider-range").length > 0) {
            ...
            const currency = $("#slider-range").data('currency') || 'Rp ';
        ...
        if ($("#amount").length > 0) {
            const m_currency = $("#slider-range").data('currency') || 'Rp ';
