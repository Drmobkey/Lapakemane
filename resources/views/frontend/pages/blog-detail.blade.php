                    ...
                    <div class="blog-single-main">
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Kirim</span><span class="comment_btn reply" style="display: none;">Balas komentar</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Anda perlu <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Masuk</a> ATAU <a style="color:blue" href="{{route('register.form')}}">Daftar</a>untuk berkomentar.
